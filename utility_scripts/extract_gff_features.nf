...
cache 'deep'
conda "conda-forge:coreutils bioconda::ucsc-fasplit bioconda::seqkit"
input:
 path fasta_ch1
...
process filterGFF {
conda "conda-forge::pango bioconda::seqkit bioconda::genometools-genometools conda-forge::grep"
cache 'deep'
input:
...
process makeGtIndex {
conda "conda-forge::pango bioconda::genometools-genometools"
...
conda "conda-forge::pango bioconda::seqkit bioconda::genometools-genometools"
cache 'deep'
input:
