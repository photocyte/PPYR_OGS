...
nextflow run ./utility_scripts/extract_gff_features.nf --gff /lab/weng_scratch/Tim/PPYR_OGS/tmp.${BASE}.gt.gff3 --fasta /lab/weng_scratch/Tim/PPYR_OGS/Genome_release.fa -resume -with-trace
